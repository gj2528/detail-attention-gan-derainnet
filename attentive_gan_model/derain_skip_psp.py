...
from attentive_gan_model import att_gan_skip_psp
...
class DeRainNet(object):
    ...
    def __init__(self, phase):
        ...
        """
        self._phase = phase
        self._attentive_gan = att_gan_skip_psp.GenerativeNet(self._phase)
    ...
    def inference(self, input_tensor, name, reuse=False):
        ...
        return output['output_3'], attentive_rnn_out['attention_map_list']
