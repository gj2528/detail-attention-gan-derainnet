#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# @Time    : 19-11-12 上午10:00
# @Author  : gj2528
# @Site    : https://github.com/
# @File    : att_gan_skip_psp.py
# @IDE: PyCharm
"""
...
class GenerativeNet(cnn_basenet.CNNBaseModel):
    ...
    def build_autoencoder(self, input_tensor, name, reuse=False):
        ...
        with tf.variable_scope(name, reuse=reuse):
            ...
            print(dia_conv1.shape,'dia_conv1')
            ...
            print(dia_conv2.shape, 'dia_conv2')
            ...
            print(dia_conv3.shape, 'dia_conv3  ')
            ...
            shape_12 = tf.shape(relu_12)[1:3]

            conv_12_pool = self.pspnet_block(relu_12, 20, 30, 20, 30, shape_12, name='conv_12_pool')

            deconv_1 = self.deconv2d(inputdata=conv_12_pool, out_channel=128, kernel_size=4,
            ...
            shape_14 = tf.shape(relu_14)[1:3]

            conv_14_pool = self.pspnet_block(relu_14, 20, 30, 20, 30, shape_14, name='conv_14_pool')

            deconv_2 = self.deconv2d(inputdata=conv_14_pool, out_channel=64, kernel_size=4,
            ...
            shape_16 = tf.shape(relu_16)[1:3]

            conv_16_pool = self.pspnet_block(relu_16, 20, 30, 20, 30, shape_16, name='conv_16_pool')


            skip_output_1 = self.conv2d(inputdata=conv_12_pool, out_channel=3, kernel_size=3,
                                        padding='SAME', stride=1, use_bias=False,
                                        name='skip_ouput_1')

            skip_output_2 = self.conv2d(inputdata=conv_14_pool, out_channel=3, kernel_size=3,
                                        padding='SAME', stride=1, use_bias=False,
                                        name='skip_output_2')

            skip_output_3 = self.conv2d(inputdata=conv_16_pool, out_channel=3, kernel_size=3,
                                        padding='SAME', stride=1, use_bias=False,
                                        name='skip_output_3')
            print(skip_output_1.shape,'skip_output_1')
            print(skip_output_2.shape, 'skip_output_2')
            print(skip_output_3.shape, 'skip_output_3')
            # 传统GAN输出层都使用tanh函数激活
