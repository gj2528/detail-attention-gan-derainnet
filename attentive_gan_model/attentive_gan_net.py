...
if __name__ == '__main__':
    input_image = tf.placeholder(dtype=tf.float32, shape=[1, 320, 480, 3])
    auto_label_image = tf.placeholder(dtype=tf.float32, shape=[1, 320, 480, 3])
    rnn_label_image = tf.placeholder(dtype=tf.float32, shape=[1, 320, 480, 1])
